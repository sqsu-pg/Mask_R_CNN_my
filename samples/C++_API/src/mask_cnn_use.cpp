 ...
 * @LastEditTime: 2021-11-25 20:19:05
...
int main()
{
    ...
    py_module = PyImport_ImportModule("Mask_class");
    ...
    // //doing 获取类
    py_class = PyObject_GetAttrString(py_module, "Mask");
    ...
    PyObject_CallMethod(py_Instance, "GetDynSeg", nullptr);
