 ...
 * @LastEditTime: 2021-12-08 16:46:02
...
int main()
{
    ...
    PyRun_SimpleString("sys.path.append('/home/liubo/Mask_RCNN/samples')");
    // PyRun_SimpleString("sys.path.append('/home/liubo/SLAM/DynaSLAM/src/python')");
    ...
    cv::Mat img = cv::imread("/home/liubo/Mask_RCNN/samples/C++_API/src/000000005037.jpg");
    // cv::Mat img = cv::imread("/home/liubo/data_sets/00/image_0/000001.png");
    //doing 检查图片是否读入成功
    if (img.empty())
    {
        return -1;
    ...
    PyObject* args = Py_BuildValue("(O)", PyArray);
    ...
    cout << "返回值 " << endl;
    PyObject* pRet = NULL;
    //! pRet = PyObject_CallMethodObjArgs(pInstance, pFunc, ArgList); 这方法不对
    //! pRet = PyObject_CallMethod(pInstance, "GetDynSeg1", "(0)", args);　这方法不对
    ...
    // fstream file;
    // file.open("/home/liubo/Mask_RCNN/samples/C++_API/src/mask.txt");
    ...
    cv::imwrite("Mask_result_channel.png", mv[0]);

    // cv::namedWindow("Mask_result", cv::WINDOW_AUTOSIZE);
    // cv::imshow("Mask_result", mask_img);
    // cv::waitKey(0);
    // cv::destroyWindow("Mask_result");
