...
ROOT_DIR1 = os.path.abspath("/home/liubo/Mask_RCNN")
sys.path.append(ROOT_DIR1)

import tensorflow as tf

tf.compat.v1.disable_eager_execution()#add for ros
...
session = tf.Session(config=config)#add for ros
import keras #add for ros
keras.backend.set_session(session)#add for ros

class Mask:
    def __init__(self):
       print ("Initializing Mask RCNN network....") 
       ROOT_DIR = os.path.abspath("/home/liubo/Mask_RCNN")
    ...
    #    with tf.device(self.DEVICE):
       ...
       self.model.keras_model._make_predict_function() #add for ros
    ...
    def GetAndReturnMask(self, image):
